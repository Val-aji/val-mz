function ComponentFilter(props) {
   return (
      ...
      <div 
        className=" bg-slate-50 border-2 my-2 rounded-md drop-shadow px-3 pt-6 w-5/6 mx-auto" id="componentFilter">
          {/*Tombol CLose */ }
          ...
          <div className="flex w-full justify-end my-1">
              <button className="p-2 rounded-md bg-cyan-600 " onClick={props.handleReset}> 
                  Reset Filter 
              </button> 
          </div>
      </div>
